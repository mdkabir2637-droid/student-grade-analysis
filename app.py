...
# ---------------- DOWNLOAD AS CSV ----------------
        ...
        ax1.set_xticklabels(df["Name"], rotation=0, ha="centre")
        ...
        st.download_button(
            label="⬇ Download Student Performance Graph",
            data=buffer1,
        ...
        st.download_button(
            label="⬇ Download Grade Distribution Chart",
            data=buffer2,
        ...
        st.download_button(
            label="⬇ Download Subject Average Graph",
            data=buffer3,
